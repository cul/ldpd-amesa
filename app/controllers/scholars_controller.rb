class ScholarsController < ApplicationController
  ...
  # Uses Google Custom Search (https://cse.google.com/cse/)
  def gcs_search
  end
  ...
  def show
    ...
    @field_names_values =
      [ [t('scholar.region_of_interest'),
        ...
        [t('scholar.email'), helpers.mail_to(@scholar.email, nil, class: "scholar-email")],
        [t('scholar.mailing_address'), @scholar.mailing_address],
        [t('scholar.phone_fax_numbers'), @scholar.phone_fax_numbers],
        [t('scholar.website'), @scholar.website.blank? ? nil : helpers.link_to(nil, @scholar.website, class: "scholar-website")],
